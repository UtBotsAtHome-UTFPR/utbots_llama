...
setup(
    ...
    # Arquivos de dados que não são .py, como o package.xml e os seus recursos
    data_files=[
        ('share/ament_index/resource_index/packages',
            ['resource/' + package_name]),
        ('share/' + package_name, ['package.xml']),
        # Inclui todos os arquivos de lançamento (launch) que estiverem na pasta 'launch'
        (os.path.join('share', package_name, 'launch'), glob(os.path.join('launch', '*.launch.py'))),
        # IMPORTANTE: Inclui os arquivos de contexto para o ChromaDB
    ...
    # Define o executável do seu nó ROS 2
    entry_points={
        'console_scripts': [
